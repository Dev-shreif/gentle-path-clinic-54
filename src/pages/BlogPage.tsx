      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <Card className="overflow-hidden border-border/50 shadow-xl">
              <div className="grid lg:grid-cols-2 gap-0">
                ...
                <CardContent className="p-8 lg:p-12 flex flex-col justify-center">
                  ...
                  <Button className="gradient-calm text-white hover:opacity-90 w-fit">
                    Read Full Article
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {regularArticles.map((article, index) => (
            <Card 
              key={article.id} 
              className="group hover:shadow-xl transition-all duration-500 hover:-translate-y-1 border-border/50 overflow-hidden"
            ...
            <CardContent className="p-8 md:p-12 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
                <input 
                  ...
                  className="px-4 py-2 rounded-lg border border-border/50 flex-1 focus:outline-none focus:ring-2 focus:ring-primary/20"
                />
