        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <motion.div variants={itemVariants}>
              <Badge 
                variant="secondary" 
                className="mb-4 bg-white/90 text-primary border-primary/20 backdrop-blur-sm shadow-lg"
              >
            ...
            <motion.h1 
              ...
              className="text-4xl md:text-6xl lg:text-7xl font-light leading-tight text-slate-800"
            >
            ...
            >
              <Link to="/booking">
                <Button 
                  size="lg" 
                  className="gradient-calm hover:opacity-90 text-slate-800 shadow-xl px-8 py-6 text-lg rounded-full border-0"
                >
              ...
              <Link to="/doctors">
                <Button 
                  size="lg" 
                  variant="outline" 
                  className="border-slate-300 hover:bg-white/80 backdrop-blur-sm bg-white/60 px-8 py-6 text-lg rounded-full shadow-lg text-slate-700 hover:text-slate-800"
                >
