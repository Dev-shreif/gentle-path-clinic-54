          ...
          >
            <div>
              ...
              <div className="space-y-6">
                {[
                  ...
                  >
                    <motion.div 
                      className="bg-primary/10 p-3 rounded-xl group-hover:bg-primary/20 transition-colors"
            ...
            >
              ...
              <div className="grid gap-4">
                ...
                >
                  <Button 
                    className="gradient-calm text-white hover:opacity-90 justify-start w-full" 
                ...
                >
                  <Button 
                    variant="outline" 
                    className="border-primary/20 hover:bg-primary/5 justify-start w-full" 
            ...
            >
              ...
              <motion.div 
                className="bg-gradient-to-br from-primary/5 to-secondary/5 rounded-lg h-64 flex items-center justify-center border border-border/50 cursor-pointer transition-all duration-300"
                          ...
                          <div className="grid grid-cols-3 gap-3 mt-2">
                            {["Email", "Phone", "WhatsApp"].map((method) => (
                              <motion.button
                                key={method}
                                type="button"
                                onClick={() => updateForm("preferredContact", method)}
                    ...
                    {currentStep < totalSteps ? (
                      <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                        <Button 
                          type="button" 
                          onClick={nextStep}
                          className="gradient-calm text-white"
                        >
                          Next Step
                        </Button>
                      </motion.div>
                      ...
                      >
                        <Button 
                          type="submit" 
                          className="gradient-calm text-white relative overflow-hidden"
                        >
                          <motion.div
