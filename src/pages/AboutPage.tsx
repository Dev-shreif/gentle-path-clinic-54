...
const AboutPage = () => {
  ...
  return <div ref={containerRef} className="min-h-screen pt-24 pb-16 overflow-hidden">
      {/* Parallax Background */}
      <motion.div className="fixed inset-0 bg-gradient-to-br from-primary/5 via-background to-secondary/5 -z-10" style={{
      y,
      opacity
    }} />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          ...
          duration: 0.8
            ...
            <h1 className="text-4xl md:text-5xl font-light text-balance mb-6">
              About{" "}
              <motion.span className="bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent font-medium" initial={{
              opacity: 0,
              x: -20
            }} animate={{
              opacity: 1,
            ...
            <motion.p className="text-xl text-muted-foreground max-w-3xl mx-auto text-balance" initial={{
            opacity: 0,
            y: 20
          }} animate={{
            opacity: 1,
        ...
        once: true
          ...
          <Card className="bg-gradient-to-r from-primary/5 to-secondary/5 border-border/50 overflow-hidden">
            <CardContent className="p-8 md:p-12 text-center relative">
              ...
              <motion.div className="absolute top-12 right-12 text-3xl" animate={{
              y: [0, -8, 0],
              rotate: [0, -5, 0]
            }} transition={{
              duration: 4,
              ...
              <motion.h2 className="text-2xl md:text-3xl font-light mb-6" initial={{
              opacity: 0,
              y: 20
            }} whileInView={{
              opacity: 1,
              ...
              <motion.p className="text-lg text-muted-foreground max-w-4xl mx-auto leading-relaxed" initial={{
              opacity: 0,
              y: 20
            }} whileInView={{
              opacity: 1,
        ...
        <div className="mb-24">
          <motion.h2 className="text-3xl font-light text-center mb-12" initial={{
          opacity: 0,
          y: 30
        }} whileInView={{
          opacity: 1,
            ...
            scale: 1.02
                ...
                <Card className="text-center hover:shadow-lg transition-all duration-300 border-border/50 h-full">
                  <CardContent className="p-6">
                    <motion.div className="relative mb-4" whileHover={{
                  scale: 1.1,
                  rotate: 5
                }} transition={{
                  duration: 0.3
        ...
        <div className="mb-24">
          ...
          <div className="relative max-w-4xl mx-auto">
            ...
            <motion.div className="absolute left-1/2 transform -translate-x-px h-full w-1 bg-gradient-to-b from-primary to-secondary rounded-full" initial={{
            height: 0
          }} whileInView={{
            height: "100%"
          }} transition={{
            ...
            <div className="space-y-16">
              {timeline.map((event, index) => <motion.div key={index} className={`flex items-center ${index % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'}`} initial={{
              opacity: 0,
              x: index % 2 === 0 ? -50 : 50
            }} whileInView={{
              opacity: 1,
              ...
              once: true
                  ...
                  duration: 0.3
                      ...
                      <Card className="border-border/50 hover:shadow-xl transition-all duration-500 bg-card/80 backdrop-blur-sm">
                        <CardContent className="p-6 font-normal">
                  ...
                  <motion.div className="relative flex-shrink-0 w-6 h-6 bg-primary rounded-full border-4 border-background shadow-lg z-10" initial={{
                scale: 0
              }} whileInView={{
                scale: 1
              }} transition={{
                ...
                once: true
                    ...
                    <motion.div className="absolute inset-0 bg-primary rounded-full" animate={{
                  scale: [1, 1.5, 1],
                  opacity: [1, 0, 1]
                }} transition={{
                  duration: 2,
        ...
        once: true
          ...
          <div className="grid md:grid-cols-4 gap-8 text-center">
            ...
            icon: "⭐"
          }].map((stat, index) => <motion.div key={index} className="space-y-2" initial={{
            opacity: 0,
            scale: 0.5
          }} whileInView={{
            opacity: 1,
            ...
            once: true
                ...
                <motion.div className="text-2xl mb-2" animate={{
              y: [0, -5, 0]
            }} transition={{
              duration: 2,
              repeat: Infinity,
              delay: index * 0.5
                ...
                <motion.div className="text-3xl md:text-4xl font-light text-primary" initial={{
              scale: 0
            }} whileInView={{
              scale: 1
            }} transition={{
        ...
        once: true
          ...
          <Card className="bg-gradient-to-r from-primary/10 to-secondary/10 border-border/50 overflow-hidden">
            <CardContent className="p-8 md:p-12 relative">
              ...
              <motion.div className="absolute top-4 right-4 flex space-x-1" whileHover={{
              scale: 1.1
            }}>
                {[...Array(5)].map((_, i) => <motion.div key={i} className="w-1 bg-primary rounded-full" animate={{
                height: [20, 30, 20]
              }} transition={{
                duration: 1,
                repeat: Infinity,
              ...
              <motion.h2 className="text-2xl md:text-3xl font-light mb-4" initial={{
              opacity: 0,
              y: 20
            }} whileInView={{
              opacity: 1,
              ...
              <motion.p className="text-muted-foreground mb-6 max-w-2xl mx-auto" initial={{
              opacity: 0,
              y: 20
            }} whileInView={{
              opacity: 1,
